...
@Slf4j
@Service
public class GrafBuilderServiceImpl implements GrafBuilderService {
    ...
    public GrafBuilderServiceImpl(EtlServiceImpl etlService, StepRepository stepRepository, StepInstanceRepository stepInstanceRepository, EtlInstanceRepository etlInstanceRepository) {
